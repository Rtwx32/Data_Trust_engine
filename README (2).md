...
النتيجة: لوحة تحكم (Dashboard) تفاعلية توضح لكل سجل درجة ثقته، حالته (✅ موثوق / ⚠️ يحتاج مراجعة / 🚨 مرفوض)، وكل الإشارات (إحصائية، سببية، دلالية، تلاعب، تحيز) التي ساهمت في القرار.
